              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-8">
                  <div className="text-center">
                    ...
                    <img 
                      src="https://api.qrserver.com/v1/create-qr-code/?size=96x96&data=https://trusttrack-website.bolt.new/dbp.html" 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="bg-white border border-gray-200 rounded-2xl p-8">
                  <div className="text-center">
                    ...
                    <img 
                      src="https://api.qrserver.com/v1/create-qr-code/?size=96x96&data=https://trusttrack-website.bolt.new/esg.html" 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="bg-white border border-gray-200 rounded-2xl p-8">
                  <div className="text-center">
                    ...
                    <img 
                      src="https://api.qrserver.com/v1/create-qr-code/?size=96x96&data=https://trusttrack-website.bolt.new/cbam.html" 
