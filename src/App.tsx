              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-8">
                  <div className="text-center">
                    ...
                    <h4 className="text-lg font-medium text-gray-900 mb-6">Battery Passport</h4>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="space-y-4 text-sm">
                      ...
                      <div className="text-xs text-gray-500 mt-4">
                        Saves significant operational costs vs. consultants
                      </div>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    ...
                    Saves significant operational costs vs. manual reporting and consultants, while eliminating manual reporting pain.
                  </p>
                  <div className="space-y-6">
